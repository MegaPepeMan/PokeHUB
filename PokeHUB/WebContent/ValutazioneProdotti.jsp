						...
						<script>
							$('#<%=prodotto.getIdProdotto()%>').on('click', function() {
								...
								Swal.fire({
									  ...
									  html: '<form action="RatingControl" method="get"><h1 class="testoValutaProdottoPopUp">Valuta "<%=prodotto.getNomeProdotto()%>"</h1><div class="containerValutazione"><input type="hidden" name="prodotto" value="<%=prodotto.getIdProdotto()%>"><input type="radio" id="radio1" name="rating" value="1" required><label for="radio1"><ion-icon name="star" size="large"></ion-icon></label><input type="radio" id="radio2" name="rating" value="2" required><label for="radio2"><ion-icon name="star" size="large"></ion-icon></label><input type="radio" id="radio3" name="rating" value="3" required><label for="radio3"><ion-icon name="star" size="large"></ion-icon></label><input type="radio" id="radio4" name="rating" value="4" required><label for="radio4"><ion-icon name="star" size="large"></ion-icon></label><input type="radio" id="radio5" name="rating" value="5" required><label for="radio5"><ion-icon name="star" size="large"></ion-icon></label></div> <button type="submit" class="bottoneInserisci">Inserisci</button></form>',
