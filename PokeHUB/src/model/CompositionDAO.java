...
public class CompositionDAO {
		...
		public synchronized void doSave(CompositionBean composizione) throws SQLException {
			...
			String insertSQL = "INSERT INTO " +CompositionDAO.TABLE_NAME
					+ " ( identificativo_prodotto,identificativo_ordine,quantità,prezzo_acquisto,iva_acquisto) VALUES (?,?,?,?,?)";
		...
		public void doUpdate(CompositionBean composizione) throws SQLException {
			...
			String updateSQL =" UPDATE "+CompositionDAO.TABLE_NAME+" SET quantità = ?,prezzo_acquisto = ?,iva_acquisto = ? WHERE (identificativo_ordine = ? AND identificativo_prodotto= ?)" ;
